...
/*   Updated: 2017/05/17 12:31:29 by lbopp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	tok_lst->next->next->next->next->next->content = ft_strdup("fifi");
