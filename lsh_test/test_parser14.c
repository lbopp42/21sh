...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/18 09:47:17 by lbopp             #+#    #+#             */
/*   Updated: 2017/05/18 12:43:24 by lbopp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char		**array;
	const char	*array_ref[4] = {"ls -a -l -e", "cat", ">", NULL};
	int			i;
...
void	test_parser14(t_token *tok_lst, int nb_tok)
{
	t_tuple	*tmp;
